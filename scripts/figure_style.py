...
LABELS = {
    'fr': {
        ...
        'citations_title': 'La CADHP privilégie l\'auto-référence\ndans ses citations inter-systémiques',
    ...
    'en': {
        ...
        'citations_title': 'The ACHPR favors self-reference\nin its cross-system citations',
